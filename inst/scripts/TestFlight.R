...
res <- fh_hunter(
  ...
  n_likes = "auto",           #genes for UMAP and Regression,When "auto", UMAP/logistic will use the count of genes whose 95% CI does not cross 0 within the composite bar plot candidate set.
